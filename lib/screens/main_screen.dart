...
class _MainScreenState extends State<MainScreen> {
  ...
  final List<Color?> colorsbf = [
    Color(0xFF3B3B4F),
    Color(0xFF3E345E),
    Color(0xFF2C4F3C)
  ];

  final List<Widget> linksScreen = [
    ChatbotScreen(),
    OCRScannerScreen(),
    TemplatesScreen()
  ];
          ...
          children: [
            Text(
              ...
              style: Theme.of(context)
                  .textTheme
                  .titleMedium
                  ?.copyWith(color: const Color(0xFF1C1C2E), fontSize: 24),
            ),
    ...
    return StreamBuilder<QuerySnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        final docs = snapshot.data!.docs.where((doc) {
          ...
          final hasTitle = data['file_title'] != null &&
              data['file_title'].toString().isNotEmpty;
          final hasExtension = data['extension'] != null &&
              data['extension'].toString().isNotEmpty;
          final hasType = data['fileType'] != null &&
              data['fileType'].toString().isNotEmpty;
          final language = data['language'] != null &&
          ...
          child: GridView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              final formattedDate = timestamp != null
                  ...
                  : 'Unknown Date';
              final extension =
                  data['extension']?.toString().toLowerCase() ?? '';
              String imageAsset;
              if (['png', 'jpg', 'jpeg', 'bmp', 'gif', 'webp']
                  .contains(extension)) {
                imageAsset = 'assets/images/docuImage.png';
              } else if (['doc', 'docx', 'txt', 'rtf', 'odt']
                  .contains(extension)) {
  ...
  String _getPreviewText(Map<String, dynamic> chatData) {
    ...
    userKeys.sort((a, b) =>
        int.parse(b.substring(4)).compareTo(int.parse(a.substring(4))));
    assistantKeys.sort((a, b) =>
        int.parse(b.substring(9)).compareTo(int.parse(a.substring(9))));
        ...
        builder: (context, snapshot) {
          ...
          return ListView(
            ...
            children: [
              ...
              ListTile(
                leading:
                    const Icon(Icons.file_copy_rounded, color: Colors.white),
                title: Text('Library',
                    style: Theme.of(context)
                        .textTheme
                        .bodyMedium
            ...
            onTap: () async {
              if (index == 0) {
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                      builder: (_) =>
                          ChatbotScreen(uid: widget.uid, chat_id: chat_id.id)),
                );
              } else if (index == 1) {
                var chat_id = await FirebaseFirestore.instance
                    .collection("users")
                ...
                Navigator.push(
                  context,
                  MaterialPageRoute(builder: (_) => TemplatesScreen()),
                );
              }
            },
          );
          ...
          Container(
            ...
            child: Center(
              child: Image.asset(
                ...
                fit: BoxFit.contain,
                color:
                    iconBgColor, // This will tint the image with the specified color
              ),
            ),
          ),
