...
import 'package:legallyai/screens/document_screens/chat_threads.dart';

import 'package:legallyai/screens/main_screen.dart';
import 'package:legallyai/services/docu_chat_webh_service.dart';
...
class _ChatbotScreenState extends State<ChatbotScreen> {
  ...
  final chatService = DocumentChatWebService();
...
void _setupFirebaseListener() {
  _chatListener = FirebaseFirestore.instance
    ...
    if (filteredData.containsKey('assistant$messageIndex')) {
      ...
      setState(() {
        isWaitingForResponse = false;  // Reset waiting state when we get a response
...
void _setupChatService() {
  ...
  try {
    ...
    _contentSubscription = chatService.contentStream.listen(
      (data) {
        // Remove message handling from here
